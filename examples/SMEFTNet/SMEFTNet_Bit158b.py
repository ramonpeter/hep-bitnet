    ...
    def __init__(self, 
      ...
      #      negative_slope = 0.01,
        ...
        for l, (dropout, hidden_layers) in enumerate(conv_params):
         ...
         #       _mlp.activation.negative_slope = negative_slope
        ...
        self.mlp = CMLP( [EC_out_chn+self.num_scalar_features]+readout_params[1]+[num_classes], dropout=readout_params[0], activation="leakyrelu",batch_norm=self.readout_batch_norm)
    #    self.mlp.activation.negative_slope = negative_slope
