...
state_dict = torch.load('/users/daohan.wang/SMEFTNet/NN/models/SMEFTNet/regress_wz_eft/eft_wz_regressed/best_state.pt')
...
np.savez('/users/daohan.wang/SMEFTNet/test_data.npz', output = output, target = target, decay_phi = decay_phi)
